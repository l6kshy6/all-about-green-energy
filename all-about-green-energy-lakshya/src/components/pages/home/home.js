  ...
  const homeContent = [
    {
      ...
      position: "-650px", /*changes the horizontal offset of the image, positive value pans image to left, negative pans to right*/
      btnIndex: 0,
    ...
    },
    {
      ...
      position: "-60px", /*changes the horizontal offset of the image, positive value pans image to left, negative pans to right*/
      btnIndex: 0,
    ...
    },
    {
      ...
      position: "-140px", /*changes the horizontal offset of the image, positive value pans image to left, negative pans to right*/
      btnIndex: 0,
          ...
          return (
            <Fade bottom>
              <div className="content-container">
                {isEven(index) ? (
                  <img src={item.img} className="half" style={{objectPosition:item.position}} />
                ) : (
                  <HomeText />
                )}
                {!isEven(index) ? (
